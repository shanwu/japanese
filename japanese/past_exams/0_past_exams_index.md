...
```mermaid
pie title JLPT N4 分數分佈 (滿分 180 分)
    "言語知識 (文字・語彙・文法) + 読解" : 120
    "聴解 (聽力)" : 60
```
...
| :--- | :--- | :---: | :---: | :--- |
| **言語知識・読解** | 文字・語彙（25分鐘）<br>文法・読解（55分鐘） | 0 ～ 120 分 | **38 分** | ① 總得分 $\ge$ **90 分**<br>② 言語知識・読解 $\ge$ **38 分**<br>③ 聴解 $\ge$ **19 分**<br>*(兩科目皆不可低於基準點)* |
...
| **2022 年 07 月** | [2022_07_jlpt_n4_exam.md](./2022_07_jlpt_n4_exam.md) | 工事・進んで・数えて・営業、状態副詞（どんどん）、授受/被動態、排序題還原、聽解正解表全收錄 |
| **2021 年 12 月** | [2021_12_jlpt_n4_exam.md](./2021_12_jlpt_n4_exam.md) | 出發・最後・調べる、～たり～たりする、並列助詞、聽解原文全收錄 |
| **2021 年 07 月** | [2021_07_jlpt_n4_exam.md](./2021_07_jlpt_n4_exam.md) | 足・急に・昼間・案内、原因理由「で」、使役態（安心させる）、排序題還原、聽解正解表全收錄 |
| **2020 年 12 月** | [2020_12_jlpt_n4_exam.md](./2020_12_jlpt_n4_exam.md) | 題量改版新制首回、文字語彙文法正解、排序題全真還原、聽解完整對白全收錄 |
...
```mermaid
flowchart TD
    M1["1. 動詞變態體系<br>(被動形 れる/られる ＋ 使役形 せる/させる)"] --> PASS["N4 合格核心"]
    M2["2. 授受動詞與請求<br>(あげる / もらう / くれる / ていただく)"] --> PASS
    M3["3. 假定與條件表達<br>(と・ば・たら・なら 4大區隔)"] --> PASS
    M4["4. 時態與情態副詞<br>(～たところ / ～ばかり / ～ことにする)"] --> PASS
    M5["5. 敬語基礎骨架<br>(尊敬語 お/ご～になる vs 謙讓語 お/ご～する)"] --> PASS
    M6["6. 形容詞過去式與否定<br>(～かった / ～くなかった / よかった)"] --> PASS
```
