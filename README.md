...
```text
詳細教我圖中的內容日文，包括列出相關的單字、句子，還有任何可以補充幫我更了解的詳細解說和資訊，補充下中文解說，因為沒有圖，要更詳細描述場景，不要給我片面的資訊，幫我加一些實際的對比例句，還有說明更詳細，不然我實在不懂; 如果是題目的話，就將原題輸入，然後附上解答區，詳細解說，記得，生字表在最上面，生字表有羅馬拼音和例句，例句有中文，絕對要將結果以 markdown 輸出到 .txt，不然就失敗了
